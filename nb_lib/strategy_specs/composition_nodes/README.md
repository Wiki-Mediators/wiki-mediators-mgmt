...
| regime_attribution_panel | implemented-panel-null | Retroactively tagged closed-candidate trade logs by causal day-state. 2026-07-06 panel result: positive-looking cells exist, but no strategy-state cell survived the pre-committed corrected panel screen after FDR; no candidate promoted or revived, OOS sealed. |
